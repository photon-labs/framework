...
public class CI extends DynamicParameterAction implements FrameworkConstants {
    ...
    public String ci() {
		...
		try {
			...
			// set theme as empty, struts2 will throw the error for this special char content
			theme = "";
			if (debugEnabled) {
	        ...
	        if (CollectionUtils.isNotEmpty(parameters)) {
	            for (Parameter parameter : parameters) {
	                ...
	                if (Boolean.parseBoolean(parameter.getMultiple())) {
	                	...
	                	// for pdf report operation we have to assign our own values for technology name
	...
	public String doUpdateSave(String jobType) {
		...
		try {
			...
			if (BUILD.equals(operation)) {
				...
				// get technology name from service

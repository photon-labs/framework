...
<html>
	...
	<body>
				...
				<div class="shortcut_bottom">
					<div class="leftbotnav">
						<a href="JavaScript:void(0);" id="forum" name="headerMenu"
							class="arrow_links_bottom"><span class="shortcutRed" id="lf_tp1"></span>
							<span class="shortcutWh" id="lf_tp2"><s:text name="label.help"/></span>
						</a>
					</div>
					<div class="rightbotnav">
						<a href="JavaScript:void(0);" id="settings" name="headerMenu"
							class="arrow_links_bottom"><span class="shortcutRed" id="lf_tp1"></span>
							<span class="shortcutWh" id="lf_tp2"><s:text name="label.settings"/></span>
						</a>
					</div>
				</div>
			</div>
	    ...
	    <!-- Pop Up Starts-->
	    <div class="popup_div" id="popup_div"></div>
	    <!-- Pop Up Ends -->
	</body>

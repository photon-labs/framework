...
<%
    ...
    List<DownloadInfo> projectInfoServers = null;
    List<DownloadInfo> projectInfoDatabases = null;
    ...
    if (settingsTemplate != null) {
    	projectInfoServers = (List<DownloadInfo>) request.getAttribute(FrameworkConstants.REQ_TEST_SERVERS);
    	projectInfoDatabases = (List<DownloadInfo>) request.getAttribute(FrameworkConstants.REQ_PROJECT_INFO_DATABASES);
						...
						<%
						    String checkedStr = "";
													...
													if (settingsInfo != null) {
														...
														if (project != null){
															selectedAppliesTos = Arrays.asList(project.getApplicationInfo().getTechInfo().getVersion());
															disableStr = "disabled";
														}
													}
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		%>
			...
			<%
				for(DownloadInfo projectInfoServer : projectInfoServers) {
	...
	%>
			$('#type').find('option').remove();
			<%
				for(DownloadInfo projectInfoDatabase : projectInfoDatabases) {

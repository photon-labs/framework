									...
									<div class="scrollpanel">
										<section class="scrollpanel_inner">
											<table class="download_tbl">
												...
												<% 
												String descContent = "";
					                            if (StringUtils.isNotEmpty(leftModule.getDescription())) { 
												  	descContent = leftModule.getDescription();												}
												...
												if (StringUtils.isNotEmpty(leftModule.getHelpText())) { 
												  	helpTextContent = leftModule.getHelpText();
												}
												
												List<ArtifactInfo> versions = leftModule.getVersions();
				                    ...
				                    <div class="scrollpanel">
				                        <section class="scrollpanel_inner">
				                        	<table class="download_tbl">
					                            ...
					                            <% 
					                            String descContent = "";
												if (StringUtils.isNotEmpty(rightModule.getDescription())) { 
												  	descContent = rightModule.getDescription();
												}
												...
												String helpTextContent = "";
												if (StringUtils.isNotEmpty(rightModule.getDescription())) { 
												  	helpTextContent = rightModule.getDescription();
												}

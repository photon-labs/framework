	...
	<div class="columnStyle">
				...
				<div class="fixed-table-container-inner">
					<table cellspacing="0" class="zebra-striped">
						<thead>
							<tr>
								<th class="first">
									<div class="th-inner-test"><s:text name="label.thread.name"/></div>
								</th>
								<th class="second">
									<div class="th-inner-test"><s:text name="label.date"/></div>
								</th>
								<th class="third">
									<div class="th-inner-test"><s:text name="label.elapsed.time"/></div>
								</th>
								<th class="third">
		...
		<div class="graph_div">
		    <div class="jm_canvas_div">
		        <iframe src="<%= request.getContextPath() %>/pages/applications/quality/jmeter_graph.jsp" 
		        	frameborder="0" width="500px" height="100%" style="overflow: hidden;"></iframe>
			</div>
		</div>
	</div>
</div>

	...
	<div class="modal-body perModalBody">
		<fieldset class="popup-fieldset fieldsetBottom perFieldSet">
            ...
            <div class="clearfix perClearFix">
            	<label class="xlInput popup-label perShowSettingLbl" style="width: 169px;"></label>
            	<label class="xlInput popup-label perSelectedTypeTitle">
            		<span class="red">*</span>
            		<s:text name="label.environment"/>
            	</label>
            	<label class="xlInput popup-label perfConfName" id="selectedTypeTitle" style="width: auto;">
            		<span class="red">*</span>
            		<s:text name="label.server"/>
            	</label>
            </div>
            
            <div class="clearfix perClearFix" style="padding-top: 0; margin-left: 28px;">
            	<label class="xlInput popup-label perShowSettingLbl" style="width: 140px;">
            	...
            	<label class="xlInput popup-label perfConfName" style="width: auto;">
            	...
            	<table>
					<tr>
						<td style="width: 20%; border-bottom: none;">
							<label class="xlInput popup-label perTestName" style="width: 163px">
								<span class="red">*</span>
...
<script type="text/javascript">
	...
	function progress() {
		...
		readerHandlerSubmit('load', '<%= projectCode %>', '<%= FrameworkConstants.LOAD %>', $('#formJmeterLoad'));
		return false;
	}
	
	function getTestResultFiles() {
    	performAction('tstResultFiles', $('#formJmeterLoad'), '', true);
	}

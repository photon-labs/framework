			        ...
			        <div style="overflow: auto;">
				        <table cellspacing="0" class="zebra-striped">
				          	<thead>
					            <tr>
									<th class="first">
										<div id="thDiv" class="th-inner-test"><s:text name="label.testsuite.name"/></div>
									</th>
					              	<th class="second">
					              		<div id="thDiv1" class="th-inner-test"><s:text name="label.testsuite.total"/></div>
				              		</th>
					              	<th class="third">
					              		<div id="thDiv2" class="th-inner-test"><s:text name="label.testsuite.success"/></div>
				              		</th>
					              	<th class="third">
					              		<div id="thDiv3" class="th-inner-test"><s:text name="label.testsuite.failure"/></div>
				              		</th>
					              	<th class="first">
					              		<div id="thDiv4" class="th-inner-test"><s:text name="label.testsuite.error"/></div>
				              		</th>
					            </tr>
				          	</thead>

...
<form autocomplete="off" class="marginBottomZero" id="formUnit">
	<div class="operation">
		...
		<div class="icon_fun_div printAsPdf">
			...
			<a href="#" id="copyPath">
				<img src="images/icons/copy-path.png" title="Copy path"/>
			</a>
		</div>
...
function loadTestResults() {
	...
	performAction('fillTestSuites', $('#formQuality'), '', true, params);
}

function testReport() {
	var params = "testType=";
	params = params.concat('<%= FrameworkConstants.UNIT %>');
	performAction('testReport', $('#formUnit'), $('#testSuiteDisplay'), '', params);
...
function unitTestProgress() {
	disableScreen();
  	...
  	getCurrentCSS();
  	readerHandlerSubmit('unit', '<%= projectCode %>', '<%= FrameworkConstants.UNIT %>', $('#formQuality'));
}
...
function openAndroidPopup() {
	...
	var params = "testType=";
	params = params.concat("unit");
	popup('testAndroid', '', $('#popup_div'), '', '', params);
}

function openIphoneNativeUnitTestPopup() {
	var params = "testType=";
	params = params.concat("unit");
	popup('testIphone', $('#formUnit'), $('#popup_div'), '', '', params);
}
...
function openUnitTestPopup() {
	...
	var params = "testType=";
	params = params.concat("unit");
	popup('generateUnitTest', $('#formUnit'), $('#popup_div'), '', '', params);
}
</script>
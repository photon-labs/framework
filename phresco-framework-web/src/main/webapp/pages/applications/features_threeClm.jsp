...
<% } %>
	...
	<div class="clearfix" style="margin: 5px 0 0 5px;">
	    ...
	    <div class="input">
	    	...
	    	//TODO:Need to handle
// 	    		if(StringUtils.isNotEmpty(appInfo.getPilotProjectName())) {
// 	    			pilotProject = appInfo.getPilotProjectName();
// 	    		}
	    	%>
					                    ...
					                    <div class="scrollpanel">
					                        <section class="scrollpanel_inner">
					                        	<table class="download_tbl">
													...
													<% 
													String descContent = "";
													if (StringUtils.isNotEmpty(coreModule.getDescription())) {
													  	descContent = coreModule.getDescription();
													}
													...
													if (StringUtils.isNotEmpty(coreModule.getHelpText())) {
													    helpTextContent = coreModule.getHelpText();
													}
						                    ...
						                    <div class="scrollpanel">
						                        <section class="scrollpanel_inner">
						                        	<table class="download_tbl">
							                            ...
							                            <%
							                            String descContent = "";
														if (StringUtils.isNotEmpty(jslibrary.getDescription())) {
														  	descContent = jslibrary.getDescription();
														}
														...
														String helpTextContent = "";
														if (StringUtils.isNotEmpty(jslibrary.getHelpText())) {
														  	helpTextContent = jslibrary.getHelpText();
														}
						                    ...
						                    <div class="scrollpanel">
						                        <section class="scrollpanel_inner">
						                        	<table class="download_tbl">
														...
														<%
														String descContent = "";
														if (StringUtils.isNotEmpty(customModule.getDescription())) { 
															descContent = customModule.getDescription();
														}
														...
														String helpTextContent = "";
														if (StringUtils.isNotEmpty(customModule.getHelpText())) { 
														  	helpTextContent = customModule.getHelpText();
														}

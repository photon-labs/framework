	...
	Clazz.com.components.features.js.Features = Clazz.extend(Clazz.WidgetWithTemplate, {
		...
		registerHandlebars : function () {
			...
			Handlebars.registerHelper('scopeShowHide',function(packaging,scope) {
				var fieldset;
				if(packaging === "jar"){
					fieldset = '<select class="jarscope" style="float:right;"><option value="compile">Compile</option><option value="provided">Provided</option><option value="test">Test</option><option value="runtime">RunTime</option></select> ';
				}
				return fieldset;
			});

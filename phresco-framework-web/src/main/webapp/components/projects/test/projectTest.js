	...
	return { runTests: function() {
		...
		runSubmitProjVersionClickTest1 : function() {
			...
			asyncTest("Add Project- Submit Project Version Click Event Test1", function() {
				...
				setTimeout(function() {
					...
					equal(projectversion, "3.2.0-SNAPSHOT", "Submit Project Version Click Event Tested");
		...
		runDulicateAppCodeValidationTest : function() {
			...
			asyncTest("Add Project- Duplicate AppCode Validation Test", function() {
				...
				$("tr[name=staticApplnLayer]").first().find(".appCodeText").keyup();
				setTimeout(function() {
					start();
		...
		dateValidateTest2 : function() {
			...
			asyncTest("Create Project- Date Validation Test2", function() {
				...
				setTimeout(function() {
					start();
					var errorMsg = $("#endDate").attr('placeholder');
					equal(errorMsg, "Start date should be lesser than the end date", "Create Project- Date Validation2 Tested");
		...
		dateValidateTest3 : function() {
			...
			asyncTest("Create Project- Date Validation Test3", function() {
				...
				setTimeout(function() {
					start();
					var errorMsg = $("#endDate").attr('placeholder');
					equal(errorMsg, "Start date should be lesser than the end date", "Create Project- Date Validation3 Tested");
		...
		dateValidateTest4 : function() {
			...
			asyncTest("Create Project- Date Validation Test4", function() {
				...
				setTimeout(function() {
					start();
					var errorMsg = $("#endDate").attr('placeholder');
					equal(errorMsg, "Start date should be lesser than the end date", "Create Project- Date Validation4 Tested");
		...
		dateValidationTest : function() {
			...
			asyncTest("Add Project- Date Validation Test", function() {
				...
				setTimeout(function() {
					start();
					var errorMsg = $("#endDate").attr('placeholder');
					equal(errorMsg, "Start date should be lesser than the end date", "Add Project - Date Validation Tested");
		...
		runSubmitProjVersionClickTest3 : function() {
			...
			asyncTest("Add Project- Submit Project Version Click Event Test3", function() {
				...
				setTimeout(function() {
					start();
					equal($("#projectversion").val(), "3.2.0-SNAPSHOT", "Submit Project Version Click Event Tested");

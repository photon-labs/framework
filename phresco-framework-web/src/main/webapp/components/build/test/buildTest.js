define(["build/build"], function(Build) {
	...
	return { 
		...
		setiPhoneAppInfo : function(){
			...
			$('.headerAppId').val('fe5478f9-7636-42d0-9093-e0878dd83dfd');
		},
		...
		setHTMLAppInfo : function(){
			...
			$('.headerAppId').val('d6528c06-b2f6-4388-8001-54e7e25d59db');
		},
		...
		setNodeAppInfo : function(){
			...
			$('.headerAppId').val('3b33c6c3-2491-4870-b0a9-693817b5b9f8');
		},

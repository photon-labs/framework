		...
		updateapplication : function(application) {
			...
			asyncTest("Test for Update Application event", function() {
				...
				$.mockjax({
				  ...
				  status: 200,
				  response : function() {
					  this.responseText = JSON.stringify({"message":null,"exception":null,"responseCode":"PHR200008","data":{"embedList":{},"projectInfo":{"endDate":null,"multiModule":false,"appInfos":[{"functionalFramework":null,"modules":null,"pomFile":null,"created":true,"pilot":false,"emailSupported":false,"pilotContent":null,"embedAppId":null,"phoneEnabled":false,"tabletEnabled":false,"dependentModules":null,"pilotInfo":null,"selectedFrameworks":null,"selectedServers":[],"selectedDatabases":[],"selectedJSLibs":["ceb6006b-b7aa-4600-9cdb-d52f5ad724ff","6afdf1d3-80f0-44a5-a9f5-843ce3db7ea0","deda98f8-c350-47f1-8b22-a0816a695127","4f889fa1-fe7a-4dee-8ed8-fb95605dcc85"],"selectedModules":["a12d56f9-ff9e-4a3f-b01a-d8cb3dfd1278","2d41a182-85f1-42a3-a67c-a0836792ba02"],"selectedComponents":[],"appDirName":"html5webyui","techInfo":{"appTypeId":"1dbcf61c-e7b7-4267-8431-822c4580f9cf","techGroupId":"HTML5","techVersions":null,"version":"3.9.1","used":false,"customerIds":null,"creationDate":1380090452000,"system":false,"helpText":null,"name":"responsive-web-yui","id":"tech-html5","displayName":null,"description":null,"status":null},"functionalFrameworkInfo":null,"selectedWebservices":[],"version":"1.0","code":"html5webyui","used":false,"customerIds":null,"creationDate":1380175377750,"system":false,"helpText":null,"name":"html5webyui","id":"626eee78-54ef-4b0d-9811-bea80408d533","displayName":null,"description":"","status":null}],"projectCode":"html5webyui","preBuilt":false,"startDate":null,"noOfApps":1,"version":"1.0","used":false,"customerIds":["photon"],"creationDate":1380090452000,"system":false,"helpText":null,"name":"html5webyui","id":"35d27b51-c28b-4d96-85eb-ca828d9edb4b","displayName":null,"description":"","status":null}},"status":"success"});
		...
		adddatabase : function(application) {
			...
			asyncTest("Test for Add Database event", function() {
				...
				setTimeout(function() {
					...
					$("input[name='appDirName']").val('.........');
					$("input[name='appDirName']").focusout();
		 ...
		 removeserverdatabase : function(application) {
			...
			asyncTest("Test for Remove Server/Database event", function() {
				...
				setTimeout(function() {
					...
					//self.updateapplication(application);
					require(["tridiongeneralTest"], function(tridiongeneralTest){
						tridiongeneralTest.runTests();
					});
				}, 3000);
			});
		}, 

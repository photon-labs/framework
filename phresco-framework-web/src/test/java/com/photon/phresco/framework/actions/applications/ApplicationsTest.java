...
//  @Test
	public void gitUpdate() throws Exception {
			boolean appInfo = scmi.updateProject("git","https://github.com/santhosh-ja/Test2.git", null, null, "master", null, null);
			Assert.assertEquals(true, true );
	}
	
//  @Test
	public void svnUpdate() throws Exception {
		boolean appInfo = scmi.updateProject("svn","https://insight.photoninfotech.com/svn/repos/phresco-svn-projects/ci/IphoneAutomationInJe/2.0/phresco-test/sample applayer-tech-php/"

...
public class EnvironmentServersImplTest {
	EnvironmentServersImpl servers = null;
	@Before
	public void setUp() throws Exception {
		servers = new EnvironmentServersImpl();
	}
	...
	public void getValues() throws  ConfigurationException, PhrescoException, IOException, ParserConfigurationException, SAXException {
		...
		PossibleValues possibleValues = servers.getValues(paramMap);

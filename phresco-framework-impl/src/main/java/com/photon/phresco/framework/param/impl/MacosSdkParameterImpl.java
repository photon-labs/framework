...
public class MacosSdkParameterImpl implements DynamicParameter {
	...
	public PossibleValues getValues(Map<String, Object> map) throws IOException, ParserConfigurationException, SAXException, ConfigurationException, PhrescoException {
		...
		List<String> macosSdks = IosSdkUtil.getMacSdks(MacSdkType.macosx);
		for (String macosSdk : macosSdks) {
				Value value = new Value();
				value.setValue(macosSdk);

...
public class Win8MetroCofigFileParser implements FrameworkConstants {
	...
	private static void elementIdentifier(Element rootNode, String elementName,	ApplicationInfo info, Namespace ns) {
	...
	public static void visitAllDirsAndFiles(File dir, ApplicationInfo info) {
		if (dir.isDirectory()) {
	...
	private static File getProjectHome(ApplicationInfo info){

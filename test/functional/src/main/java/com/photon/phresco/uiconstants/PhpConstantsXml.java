...
public class PhpConstantsXml {
	...
	public   String PHP_NONE_CONFIGURATION_SERVER_CONTEXT="phpNoneConfigServerContext";		
	public   String PHP_BLOG_CONFIGURATION_SERVER_CONTEXT="phpBlogConfigServerContext";
	...
	public   String PHP_NONE_PROJECT="phpNoneCreatedproject";

...
public class ReadXMLFile {
	...
	private static final String heliosUiConst = "./src/main/resources/HeliosUiConstants.xml";
	private static final String phrscEnv = "./src/main/resources/phresco-env-config.xml";
	private static final String heliosData = "./src/main/resources/HeliosFrameworkData.xml";
	...
	private static final String javaWSConst = "./src/main/resources/JavaWebserviceConstants.xml";
	...
	public void loadJavaWebServiceConstants() throws ScreenException {
		loadHeliosConstansts(javaWSConst);
	}

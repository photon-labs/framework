...
public class Create_Config_None extends TestCase{
    ...
    @Test
    public void testCreate_Drupal7_None() throws InterruptedException, IOException, Exception{
   ...
   @Test
    public void testCreate_Drupal6_None() throws InterruptedException, IOException, Exception{
  ...
  @Test
    ...
    @Test
    public void testCreate_PHP_None() throws InterruptedException, IOException, Exception{
    ...
    @Test
    public void testCreate_Config_Wordpress() throws InterruptedException, IOException, Exception{

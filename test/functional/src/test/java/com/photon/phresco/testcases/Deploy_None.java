...
public class Deploy_None {
	...
	@Test
    public void test_Deploy_Deploy_Drupal7_None_() throws InterruptedException, IOException, Exception{
 ...
 @Test
    public void test_Deploy_Drupal6_None() throws InterruptedException, IOException, Exception{
 ...
 public void test_Deploy_NodeJS() throws InterruptedException, IOException, Exception{
    ...
    public void test_Deploy_YuiWidget_None_Proj() throws InterruptedException, IOException, Exception{
	 ...
	 @Test
    public void test_Deploy_Config_Wordpress() throws InterruptedException, IOException, Exception{

...
public class Create_Config_Eshop extends TestCase{
	...
	String methodName;
	  ...
	  @Test
    public void testCreate_Config_Drupal7() throws InterruptedException, IOException, Exception{
   ...
   @Test
    public void testCreate_Config_MobWidget() throws InterruptedException, IOException, Exception{
                ...
                mobwidg=new MobWidgetConstantsXml();
	    		    ...
	    		    CreateDbsql dbsql = new CreateDbsql(methodName);
	    			ConfigScreen config = new ConfigScreen();
				config.MobilewidgetServerConfig(mobwidg,methodName);
				config.HTML5WidgetWebServiceConfig(YuiConst,methodName);
    }
    @Test
    public void testCreate_Config_iPhone() throws InterruptedException, IOException, Exception{
    ...
    @Test
    public void testCreate_Config_iPhoneHybd() throws InterruptedException, IOException, Exception{
    ...
    @Test
    public void testCreate_Config_JWS() throws InterruptedException, IOException, Exception{
    ...
    @Test
    public void testCreate_Config_PHP() throws InterruptedException, IOException, Exception{
    	     ...
    	     phpconst=new PhpConstantsXml();
    		    ...
    		    CreateDbsql dbsql = new CreateDbsql(methodName);
    			ConfigScreen config = new ConfigScreen();
			config.PhpDatabaseConfig(phpconst,methodName);
			config.PHPServerConfig(phpconst,methodName);
    }
    
    
   
   @Test
    public void testCreate_Config_Share() throws InterruptedException, IOException, Exception{
    ...
    @Test
    public void testCreate_Config_NodeJS() throws InterruptedException, IOException, Exception{
    ...
    @Test
    public void testCreate_Config_YuiWidget_Proj() throws InterruptedException, IOException, Exception{

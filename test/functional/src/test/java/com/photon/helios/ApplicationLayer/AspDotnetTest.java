...
public class AspDotnetTest {
	...
	@Test
	public void testAspDotnetArchetypeUpdateApp()
	throws InterruptedException, IOException, Exception {
		try {

			System.out.println("---------testAspDotnetArchetypeUpdateApp()-------------");
			methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
			appBaseScreen.aspDotnetArchetypeUpdateApp(methodName, aspDotnetConst);

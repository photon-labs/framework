...
export KARMA_HOME=$PHRESCO_HOME/workspace/tools/node_modules/karma
export GRUNT_HOME=$PHRESCO_HOME/workspace/tools/node_modules/grunt-cli
export PATH=$OCUNIT2JUNIT_HOME:$WAXSIM_HOME:$CHIEF_HOME:$CHECKER_HOME:$SONAR_HOME:$JMETER_HOME:$MAVEN_HOME/bin:$PHRESCO_HOME/bin:$PHRESCO_HOME/workspace/tools/phantomjs-1.5.0-mac/bin:$KARMA_HOME/bin:$GRUNT_HOME/bin:$PATH
mvn clean validate
